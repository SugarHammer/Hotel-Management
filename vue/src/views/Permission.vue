<template>
  <div style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      ...
      <span>权限路由名：</span><el-input v-model="search" placeholder="请输入权限路由名" style="width: 30%" clearable></el-input>
      <el-button type="primary" style="margin-left: 5px" @click="load">查询<i class="el-icon-search el-icon--right"></i></el-button>
    </div>

    <el-divider content-position="left">权限路由列表</el-divider>
    <el-table
        v-loading="loading"
        :data="tableData"
        border
    ...
    <el-dialog title="权限信息编辑" v-model="dialogVisible" width="30%">
